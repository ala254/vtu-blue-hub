...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Danjasub — Fast. Reliable. Affordable VTU" },
      { name: "description", content: "Buy data, airtime, pay electricity, cable TV, exam pins and bills instantly with Danjasub." },
      { property: "og:title", content: "Danjasub — Fast. Reliable. Affordable" },
      { property: "og:description", content: "All-in-one VTU and bill payments platform." },
